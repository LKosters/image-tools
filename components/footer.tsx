...
export function Footer({ compact }: { compact?: boolean }) {
  ...
  if (compact) {
    return (
      <footer ref={ref} className="relative p-6 md:p-8 opacity-0 h-full flex flex-col justify-end">
        <div className="flex items-end justify-between">
          <div>
            <span className="font-serif text-3xl md:text-4xl tracking-[-0.04em] select-none" style={{ color: "#1A1A28" }}>BORIUM</span>
            <div className="mt-2">
